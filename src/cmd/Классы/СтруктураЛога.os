...
Процедура ИспользоватьНастройкиИзФайла(НастройкиИзФайла) Экспорт

	НастройкиБлоков = ЗаполнитьНастройкиИзДанных(НастройкиИзФайла);

КонецПроцедуры

Процедура ИспользоватьНастройки(НастройкиИзФайла = Неопределено) Экспорт
	...
	Иначе
		...
		ИспользоватьНастройкиИзФайла(НастройкиИзФайла);
