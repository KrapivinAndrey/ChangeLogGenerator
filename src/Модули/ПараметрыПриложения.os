...
Функция ИмяПродукта() Экспорт
	...
	Возврат "oscript-changelog-generate";
...
// Возвращает имя команды "generate" (ключ командной строки)
//
//  Возвращаемое значение:
//   Строка - имя команды
//
Функция ИмяКомандыСоздатьОписание() Экспорт

	Возврат "generate";
	
КонецФункции // ИмяКомандыСоздатьОписание()
...
Функция ИмяКомандыПоУмолчанию() Экспорт
	...
	Возврат ИмяКомандыСоздатьОписание()
...
Процедура НастроитьКомандыПриложения(Знач Приложение) Экспорт
	...
	Приложение.ДобавитьКоманду(ИмяКомандыСоздатьОписание(),	"СоздатьОписаниеРелиза",          "Обновляет записи в логе изменений");
	//...
